...
import { extractPreferredImplementations, latestSolutionActionLabel, solutionProfileIsAvailable } from "./solution-profile-reader";
import {
...
export default function HomeClient({ content, today, engineering }: { content: ContentIndex; today: string; engineering: EngineeringJournalIndex }) {
  ...
  const selectedSolutionGroups = groupReaderSections(selectedProblemProfileAvailable ? selectedProblemProfile?.payload.sections ?? [] : [], true);
