...
try{
 ...
 context=await chromium.launchPersistentContext(join(process.env.LOCALAPPDATA??join(homedir(),'AppData','Local'),'General Use Chrome'),{executablePath:process.env.ARC_BROWSER_EXECUTABLE??'C:/Program Files (x86)/Google/Chrome/Application/chrome.exe',headless:true,viewport:{width:1100,height:1000},args:['--remote-debugging-port=9225']});
 ...
 console.log(JSON.stringify({sandboxBridge:'pass',existingRecordingReuse:'pass',continuousBoundary:'pass',savedResume:'pass',ended:'pass',desktop:'pass',mobile390:'pass',physicalChatgptHost:'not exercised'}));
