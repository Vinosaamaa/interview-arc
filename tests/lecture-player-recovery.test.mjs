...
function fixture(){
  class Element extends EventTarget {
    ...
    replaceChildren(){}appendChild(){}getBoundingClientRect(){return {height:800,left:0,width:390};}load(){}pause(){this.paused=true;}
  }
  ...
  const window=new EventTarget(),spoken=[],calls=[];
  ...
  return {get,spoken,calls,text,externalSave(n){revision++;offset=n;},failRead(v){readFails=v;},state:()=>({revision,offset})};
}
