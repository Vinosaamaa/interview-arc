...
export const CHATGPT_PRACTICE_TOOLS = new Set([
  "publish_learning_material", "save_learning_source_text", "query_learning_materials", "import_learning_source_url",
  "open_live_chat_controls",
  ...
  "get_learning_coaching_guide", "create_learning_course_blueprint", "revise_learning_course_blueprint", "approve_learning_course_enrollment",
  "control_learning_session", "append_learning_transcript", "attach_learning_artifact", "set_learning_homework_state", "finish_learning_session",
  "query_learning_evidence", "query_learning_journey", "query_learning_analytics",
