...
Design or LeetCode activity in the current open workbench. Behavioral
activities remain out of scope.
...
| 404 | `activity_not_found` | false | No owner-visible System Design or LeetCode activity in the open workbench. |
